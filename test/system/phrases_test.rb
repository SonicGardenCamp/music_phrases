...
class PhrasesTest < ApplicationSystemTestCase
  ...
  test "should create phrase" do
    ...
    fill_in "Author name", with: @phrase.author_name
    fill_in "Comment", with: @phrase.comment
    fill_in "Content", with: @phrase.content
    fill_in "Music title", with: @phrase.music_title
    fill_in "Play url", with: @phrase.play_url
