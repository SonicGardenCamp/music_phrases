...
class PhrasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phrase" do
    assert_difference("Phrase.count") do
      post phrases_url, params: { phrase: { author_name: @phrase.author_name, comment: @phrase.comment, content: @phrase.content, music_title: @phrase.music_title, play_url: @phrase.play_url } }
    end
  ...
  test "should update phrase" do
    patch phrase_url(@phrase), params: { phrase: { author_name: @phrase.author_name, comment: @phrase.comment, content: @phrase.content, music_title: @phrase.music_title, play_url: @phrase.play_url } }
